...
Configure `$time` and `$timezone` as explained in the comment in the code and paste the code or text yo uwant to send & run at the `{{/*YOUR CODE GOES HERE*/}}` section.
